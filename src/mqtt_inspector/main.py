...
from mqtt_inspector.accessibility import AccessibilityManager
...
def _wlc_settings_path():
    ...
    d = os.path.join(xdg, "mqtt-inspector")
...
class MainWindow(Adw.ApplicationWindow):
    ...
    def show_about(self, action, param):
        about = Adw.AboutDialog(
            application_name=_("MQTT Inspector"),
            application_icon="se.danielnylander.mqtt-inspector",
            developer_name="Daniel Nylander",
            developers=["Daniel Nylander <daniel@danielnylander.se>"],
            version=__version__,
            website="https://github.com/yeager/mqtt-inspector",
            license_type=Gtk.License.GPL_3_0,
            issue_url="https://github.com/yeager/mqtt-inspector/issues",
            translator_credits=_("Translate this app: https://www.transifex.com/danielnylander/mqtt-inspector/")
        )
        about.present(self)
...
if __name__ == '__main__':
    ...
    def _show_welcome(self, win):
        ...
        page.set_title(_("Welcome to MQTT Inspector"))
        page.set_description(_("Inspect and debug MQTT traffic.\n\n✓ Connect to MQTT brokers\n✓ Subscribe and publish\n✓ View message payloads"))
